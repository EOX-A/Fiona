...
def ensure_env(f): # -> _Wrapped[(...), Unknown, (*args: Unknown, **kwargs: Unknown), Unknown]:
...
def ensure_env_with_credentials(f): # -> _Wrapped[(...), Unknown, (*args: Unknown, **kwds: Unknown), Unknown]:
...
class GDALVersion:
    ...
    @classmethod
    def parse(cls, input): # -> Self@GDALVersion:
        """
    ...
    @classmethod
    def runtime(cls): # -> Self@GDALVersion:
...
def require_gdal_version(version, param=..., values=..., is_max_version=..., reason=...): # -> (f: Unknown) -> _Wrapped[(...), Unknown, (*args: Unknown, **kwds: Unknown), Unknown]:
