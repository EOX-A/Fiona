...
def dataset_creation_options(driver): # -> dict[Unknown, Unknown]:
...
@require_gdal_version('2.0')
def layer_creation_options(driver): # -> dict[Unknown, Unknown]:
...
@require_gdal_version('2.0')
def dataset_open_options(driver): # -> dict[Unknown, Unknown]:
...
@require_gdal_version('2.0')
def extensions(driver): # -> list[Unknown] | None:
...
@require_gdal_version('2.0')
def supported_field_types(driver): # -> list[Unknown] | None:
...
def supported_sub_field_types(driver): # -> list[Unknown] | None:
